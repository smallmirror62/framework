...
{
	/**
	 * @var Connection 与该命令关联的数据库连接
	 */
	public $db;

	/**
	 * @var \PDOStatement 该命名的PDOStatement对象
	 */
	public $pdoStatement;

	/**
	 * @var integer 此命令的默认获取模式。
	...
	/**
	 * @var \Leaps\caching\Dependency the dependency to be associated with the cached query result for this command
	 * @see cache()
	 */
	...
	/**
	 * 显式的刷新表模式 [[requireTableSchemaRefresh()]]
	 */
