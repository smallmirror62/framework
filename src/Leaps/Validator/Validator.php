 ...
 * - `captcha`: [[\Leaps\Captcha\CaptchaValidator]]
...
class Validator extends Component
{
    ...
    public static $builtInValidators = [
        'boolean' => 'Leaps\Validator\BooleanValidator',
        'captcha' => 'Leaps\Captcha\CaptchaValidator',
        'compare' => 'Leaps\Validator\CompareValidator',
        'date' => 'Leaps\Validator\DateValidator',
        'default' => 'Leaps\Validator\DefaultValueValidator',
        'double' => 'Leaps\Validator\NumberValidator',
        'each' => 'Leaps\Validator\EachValidator',
        'email' => 'Leaps\Validator\EmailValidator',
        'exist' => 'Leaps\Validator\ExistValidator',
        'file' => 'Leaps\Validator\FileValidator',
        'filter' => 'Leaps\Validator\FilterValidator',
        ...
        'number' => 'Leaps\Validator\NumberValidator',
        'required' => 'Leaps\Validator\RequiredValidator',
        ...
        'unique' => 'Leaps\Validator\UniqueValidator',
        'url' => 'Leaps\Validator\UrlValidator',
    ];
    /**
     ...
     * @param \Leaps\Base\Model $model the data model to be validated.
    ...
    public static function createValidator($type, $model, $attributes, $params = [])
    {
        ...
        return Leaps::createObject($params);
    }
    ...
    public function validate($value, &$error = null)
    {
        ...
        $params['attribute'] = Leaps::t('leaps', 'the input value');
        $params['value'] = is_array($value) ? 'array()' : $value;
        $error = Leaps::$app->getI18n()->format($message, $params, Leaps::$app->language);
     ...
     * @param \Leaps\Base\Model $model the data model being validated
     * @param string $attribute the name of the attribute to be validated.
     * @param \Leaps\Web\View $view the view object that is going to be used to render views or view files
     * containing a model form with this validator applied.
     * @return string the client-side validation script. Null if the validator does not support
     * client-side validation.
     * @see \Leaps\Widgets\ActiveForm::enableClientValidation
     */
