 ...
 *
 * Classes extending from this widget can be used in an [[Leaps\Widgets\ActiveForm|ActiveForm]]
 * using the [[Leaps\Widgets\ActiveField::widget()|widget()]] method, for example like this:
 *
 * ```php
