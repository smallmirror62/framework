...
use Leaps\Base\BootstrapInterface;
use Leaps\Base\InvalidConfigException;
use Leaps\Web\UnsupportedMediaTypeHttpException;
 ...
 * If a match is found, the [[\Leaps\Base\Application::language]] property will be set as the chosen language.
 *
...
class ContentNegotiator extends ActionFilter implements BootstrapInterface
{
	...
	/**
	 *
	 * @var string the name of the GET parameter that specifies the [[\Leaps\Base\Application::language|application language]].
	 ...
	 *      as declared in [[\Leaps\Web\Response::formatters]].
	 *     
