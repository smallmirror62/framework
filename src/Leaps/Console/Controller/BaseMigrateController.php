...
($actionID == 'create') ? [ 
	 ...
	 *
	 * ~~~
	 * leaps migrate # apply all new migrations
	 * leaps migrate 3 # apply the first 3 new migrations
	 * ~~~
	 *
	 ...
	 *
	 * ~~~
	 * leaps migrate/down # revert the last migration
	 * leaps migrate/down 3 # revert the last 3 migrations
	 * leaps migrate/down all # revert all migrations
	 * ~~~
	 *
	 ...
	 *
	 * ~~~
	 * leaps migrate/redo # redo the last applied migration
	 * leaps migrate/redo 3 # redo the last 3 applied migrations
	 * leaps migrate/redo all # redo all migrations
	 * ~~~
	 *
	 ...
	 *
	 * ~~~
	 * leaps migrate/to 101129_185401 # using timestamp
	 * leaps migrate/to m101129_185401_create_user_table # using full name
	 * leaps migrate/to 1392853618 # using UNIX timestamp
	 * leaps migrate/to "2014-02-15 13:00:50" # using strtotime() parseable string
	 * ~~~
	 *
	 ...
	 *
	 * ~~~
	 * leaps migrate/mark 101129_185401 # using timestamp
	 * leaps migrate/mark m101129_185401_create_user_table # using full name
	 * ~~~
	 *
	 ...
	 *
	 * ~~~
	 * leaps migrate/history # showing the last 10 migrations
	 * leaps migrate/history 5 # showing the last 5 migrations
	 * leaps migrate/history all # showing the whole history
	 * ~~~
	 *
	 ...
	 *
	 * ~~~
	 * leaps migrate/new # showing the first 10 new migrations
	 * leaps migrate/new 5 # showing the first 5 new migrations
	 * leaps migrate/new all # showing all new migrations
	 * ~~~
	 *
	 ...
	 *
	 * @param string $class the migration class name
	 * @return \Leaps\Db\MigrationInterface the migration instance
	 */
