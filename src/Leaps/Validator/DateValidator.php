...
class DateValidator extends Validator
{
     ...
     *
     * If this property is not set, the default value will be obtained from `Leaps::$app->formatter->dateFormat`, see [[\Leaps\I18n\Formatter::dateFormat]] for details.
     *
     ...
     * If not set, the locale of the [[\Leaps\Base\Application::formatter|formatter]] will be used.
     * See also [[\Leaps\I18n\Formatter::locale]].
     */
    public $locale;
    /**
