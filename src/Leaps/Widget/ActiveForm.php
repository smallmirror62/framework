...
{
    /**
     * @var array|string $action the form action URL. This parameter will be processed by [[\Leaps\Helper\Url::to()]].
    ...
    /**
     * @var boolean whether to hook up leaps.activeForm JavaScript plugin.
     * This property must be set true if you want to support client validation and/or AJAX validation, or if you
     * want to take advantage of the leaps.activeForm plugin. When this is false, the form will not generate
     * any JavaScript.
     */
    ...
    public function run()
    {
        ...
        if ($this->enableClientScript) {
            ...
            $view->registerJs("jQuery('#$id').leapsActiveForm($attributes, $options);");
        }
