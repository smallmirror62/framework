 ...
 *
 * Formatter is configured as an application component in [[\Leaps\Base\Application]] by default.
 * You can access that instance via `Leaps::$app->formatter`.
 *
...
class Formatter extends Component
{
     ...
     * If not set, [[\Leaps\Base\Application::language]] will be used.
     */
    public $locale;
    /**
     ...
     * If this property is not set, [[\Leaps\Base\Application::timeZone]] will be used.
     *
    ...
    public function init()
    {
        ...
        if ($this->booleanFormat === null) {
            $this->booleanFormat = [Leaps::t('leaps', 'No', [], $this->locale), Leaps::t('leaps', 'Yes', [], $this->locale)];
        }
        if ($this->nullDisplay === null) {
            $this->nullDisplay = '<span class="not-set">' . Leaps::t('leaps', '(not set)', [], $this->locale) . '</span>';
        }
    ...
    public function asRelativeTime($value, $referenceTime = null)
    {
        ...
        if ($interval->invert) {
            if ($interval->y >= 1) {
                return Leaps::t('leaps', 'in {delta, plural, =1{a year} other{# years}}', ['delta' => $interval->y], $this->locale);
            }
            if ($interval->m >= 1) {
                return Leaps::t('leaps', 'in {delta, plural, =1{a month} other{# months}}', ['delta' => $interval->m], $this->locale);
            }
            if ($interval->d >= 1) {
                return Leaps::t('leaps', 'in {delta, plural, =1{a day} other{# days}}', ['delta' => $interval->d], $this->locale);
            }
            if ($interval->h >= 1) {
                return Leaps::t('leaps', 'in {delta, plural, =1{an hour} other{# hours}}', ['delta' => $interval->h], $this->locale);
            }
            if ($interval->i >= 1) {
                return Leaps::t('leaps', 'in {delta, plural, =1{a minute} other{# minutes}}', ['delta' => $interval->i], $this->locale);
            }
            if ($interval->s == 0) {
                return Leaps::t('leaps', 'just now', [], $this->locale);
            }
            return Leaps::t('leaps', 'in {delta, plural, =1{a second} other{# seconds}}', ['delta' => $interval->s], $this->locale);
        } else {
            if ($interval->y >= 1) {
                return Leaps::t('leaps', '{delta, plural, =1{a year} other{# years}} ago', ['delta' => $interval->y], $this->locale);
            }
            if ($interval->m >= 1) {
                return Leaps::t('leaps', '{delta, plural, =1{a month} other{# months}} ago', ['delta' => $interval->m], $this->locale);
            }
            if ($interval->d >= 1) {
                return Leaps::t('leaps', '{delta, plural, =1{a day} other{# days}} ago', ['delta' => $interval->d], $this->locale);
            }
            if ($interval->h >= 1) {
                return Leaps::t('leaps', '{delta, plural, =1{an hour} other{# hours}} ago', ['delta' => $interval->h], $this->locale);
            }
            if ($interval->i >= 1) {
                return Leaps::t('leaps', '{delta, plural, =1{a minute} other{# minutes}} ago', ['delta' => $interval->i], $this->locale);
            }
            if ($interval->s == 0) {
                return Leaps::t('leaps', 'just now', [], $this->locale);
            }
            return Leaps::t('leaps', '{delta, plural, =1{a second} other{# seconds}} ago', ['delta' => $interval->s], $this->locale);
        }
    }
    ...
    public function asShortSize($value, $decimals = null, $options = [], $textOptions = [])
    {
        ...
        if ($this->sizeFormatBase == 1024) {
            switch ($position) {
                case 0:  return Leaps::t('leaps', '{nFormatted} B', $params, $this->locale);
                case 1:  return Leaps::t('leaps', '{nFormatted} KiB', $params, $this->locale);
                case 2:  return Leaps::t('leaps', '{nFormatted} MiB', $params, $this->locale);
                case 3:  return Leaps::t('leaps', '{nFormatted} GiB', $params, $this->locale);
                case 4:  return Leaps::t('leaps', '{nFormatted} TiB', $params, $this->locale);
                default: return Leaps::t('leaps', '{nFormatted} PiB', $params, $this->locale);
            }
        } else {
            switch ($position) {
                case 0:  return Leaps::t('leaps', '{nFormatted} B', $params, $this->locale);
                case 1:  return Leaps::t('leaps', '{nFormatted} KB', $params, $this->locale);
                case 2:  return Leaps::t('leaps', '{nFormatted} MB', $params, $this->locale);
                case 3:  return Leaps::t('leaps', '{nFormatted} GB', $params, $this->locale);
                case 4:  return Leaps::t('leaps', '{nFormatted} TB', $params, $this->locale);
                default: return Leaps::t('leaps', '{nFormatted} PB', $params, $this->locale);
            }
        }
    }
    ...
    public function asSize($value, $decimals = null, $options = [], $textOptions = [])
    {
        ...
        if ($this->sizeFormatBase == 1024) {
            switch ($position) {
                case 0:  return Leaps::t('leaps', '{nFormatted} {n, plural, =1{byte} other{bytes}}', $params, $this->locale);
                case 1:  return Leaps::t('leaps', '{nFormatted} {n, plural, =1{kibibyte} other{kibibytes}}', $params, $this->locale);
                case 2:  return Leaps::t('leaps', '{nFormatted} {n, plural, =1{mebibyte} other{mebibytes}}', $params, $this->locale);
                case 3:  return Leaps::t('leaps', '{nFormatted} {n, plural, =1{gibibyte} other{gibibytes}}', $params, $this->locale);
                case 4:  return Leaps::t('leaps', '{nFormatted} {n, plural, =1{tebibyte} other{tebibytes}}', $params, $this->locale);
                default: return Leaps::t('leaps', '{nFormatted} {n, plural, =1{pebibyte} other{pebibytes}}', $params, $this->locale);
            }
        } else {
            switch ($position) {
                case 0:  return Leaps::t('leaps', '{nFormatted} {n, plural, =1{byte} other{bytes}}', $params, $this->locale);
                case 1:  return Leaps::t('leaps', '{nFormatted} {n, plural, =1{kilobyte} other{kilobytes}}', $params, $this->locale);
                case 2:  return Leaps::t('leaps', '{nFormatted} {n, plural, =1{megabyte} other{megabytes}}', $params, $this->locale);
                case 3:  return Leaps::t('leaps', '{nFormatted} {n, plural, =1{gigabyte} other{gigabytes}}', $params, $this->locale);
                case 4:  return Leaps::t('leaps', '{nFormatted} {n, plural, =1{terabyte} other{terabytes}}', $params, $this->locale);
                default: return Leaps::t('leaps', '{nFormatted} {n, plural, =1{petabyte} other{petabytes}}', $params, $this->locale);
            }
        }
    }
     ...
     * @param array $options optional configuration for the number formatter. This parameter will be merged with [[numberFormatterOptions]].
     * @param array $textOptions optional configuration for the number formatter. This parameter will be merged with [[numberFormatterTextOptions]].
     * @return array [parameters for Leaps::t containing formatted number, internal position of size unit]
     * @throws InvalidParamException if the input value is not numeric or the formatting failed.
     */
