...
use Leaps\Web\CompositeUrlRule;
...
class UrlRule extends CompositeUrlRule
{
    ...
    public $prefix;
    /**
     * @var string the suffix that will be assigned to [[\Leaps\Web\UrlRule::suffix]] for every generated rule.
     */
    public $suffix;
    /**
     ...
     * @param string $prefix
     * @param string $action
     * @return \Leaps\Web\UrlRuleInterface
     */
    protected function createRule($pattern, $prefix, $action)
    {
        ...
        if (!in_array('GET', $verbs)) {
            $config['mode'] = \Leaps\Web\UrlRule::PARSING_ONLY;
        }
