 ...
 * [[page|current page]], etc. These information can be passed to [[\Leaps\Widgets\LinkPager|pagers]]
...
class Pagination extends Object implements Linkable
{
	...
	/**
	 *
	 * @var \Leaps\Web\UrlManager the URL manager used for creating pagination URLs. If not set,
