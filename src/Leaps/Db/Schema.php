...
abstract class Schema extends Object
{
     ...
     */
    public $exceptionMap = [
        'SQLSTATE[23' => 'Leaps\Db\IntegrityException',
    ];
    ...
    /**
     * @return \Leaps\Db\ColumnSchema
     * @throws \Leaps\Base\InvalidConfigException
     */
    protected function createColumnSchema()
    {
        return Leaps::createObject('Leaps\Db\ColumnSchema');
    }
    ...
    public function getTableSchema($name, $refresh = false)
    {
        ...
        if ($db->enableSchemaCache && !in_array($name, $db->schemaCacheExclude, true)) {
            /* @var $cache Cache */
            $cache = is_string($db->schemaCache) ? Leaps::$app->get($db->schemaCache, false) : $db->schemaCache;
    ...
    {
        /* @var $cache Cache */
        $cache = is_string($this->db->schemaCache) ? Leaps::$app->get($this->db->schemaCache, false) : $this->db->schemaCache;
    ...
    public function convertException(\Exception $e, $rawSql)
    {
        ...
        $exceptionClass = '\Leaps\Db\Exception';
