 ...
 *
 * leaps asset /path/to/myapp/config.php /path/to/myapp/config/assets_compressed.php
 *
...
class AssetController extends Controller
{
	 ...
	 *
	 * @throws \Leaps\Console\Exception on invalid configuration.
	 * @return \Leaps\Web\AssetManager asset manager instance.
	 */
	 ...
	 *
	 * @param \Leaps\Web\AssetManager|array $assetManager asset manager instance or its array configuration.
...
// Leaps::setAlias('@webroot', __DIR__ . '/../web');
// Leaps::setAlias('@web', '/');
...
return [
    ...
    'targets' => [
        'all' => [
            'className' => 'Leaps\Web\AssetBundle',
...
EOD;
	...
	{
		$config = Leaps::getObjectVars ( $bundle );
