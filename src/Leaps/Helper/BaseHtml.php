...
class BaseHtml
{
     ...
     * The [[\Leaps\Base\Application::charset|application charset]] will be used for encoding.
    ...
    {
        return htmlspecialchars($content, ENT_QUOTES | ENT_SUBSTITUTE, Leaps::$app ? Leaps::$app->charset : 'UTF-8', $doubleEncode);
    }
     ...
     * See [[\Leaps\Web\Request::methodParam]] for more details.
     * @param array $options the tag options in terms of name-value pairs. These will be rendered as
     * the attributes of the resulting tag. The values will be HTML-encoded using [[encode()]].
     * If a value is null, the corresponding attribute will not be rendered.
     * See [[renderTagAttributes()]] for details on how attributes are being rendered.
    ...
    {
        $header = isset($options['header']) ? $options['header'] : '<p>' . Leaps::t('leaps', 'Please fix the following errors:') . '</p>';
