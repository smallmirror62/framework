...
use Leaps\Validator\RequiredValidator;
 ...
 *
 * @property \Leaps\Validator\Validator[] $activeValidators The validators applicable to the current
 ...
 * @property ArrayObject|\Leaps\Validator\Validator[] $validators All the validators declared in the model.
...
class Model extends Service implements IteratorAggregate, ArrayAccess, Arrayable
{
     ...
     *
     * The form name is mainly used by [[\Leaps\Widgets\ActiveForm]] to determine how to name
     ...
     * ~~~
     *
     * @return ArrayObject|\Leaps\Validator\Validator[] all the validators declared in the model.
     */
     ...
     * @return \Leaps\Validator\Validator[] the validators applicable to the current [[scenario]].
     */
     ...
     * [[\Leaps\Validator\RequiredValidator|required]] validation rule in the
     * current [[scenario]].
     *
     * Note that when the validator has a conditional validation applied using
     * [[\Leaps\Validator\RequiredValidator::$when|$when]] this method will return
