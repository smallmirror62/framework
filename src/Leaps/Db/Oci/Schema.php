...
class Schema extends \Leaps\Db\Schema
{
	 ...
	 */
	public $exceptionMap = [ 
		'ORA-00001: unique constraint' => 'Leaps\Db\IntegrityException' 
	];
...
SQL;
	 ...
	 *
	 * @param $tableName
	 * @internal param \Leaps\Db\TableSchema $table->name the table schema
...
SQL;
		$sequenceName = $this->db->createCommand ( $seq_name_sql, [ 
			':tableName' => $tableName 
		] )->queryScalar ();
