...
class PageCache extends ActionFilter
{
     ...
     *
     * If [[cacheCookies]] or [[cacheHeaders]] is enabled, then [[\Leaps\Cache\Dependency::reusable]] should be enabled as well to save performance.
    ...
    public $enabled = true;
    /**
     * @var \Leaps\Base\View the view component to use for caching. If not set, the default application view component
     * [[\Leaps\Web\Application::view]] will be used.
     */
    public $view;
    /**
