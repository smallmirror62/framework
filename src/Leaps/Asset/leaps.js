 ...
 * may be accessed outside of the module. For example, you can access "leaps.sample.isActive".
 *
 * You must call "leaps.initModule()" once for the root module of all your modules.
 */
leaps = (function ($) {
    var pub = {
        /**
         ...
         * You may override this by setting `leaps.confirm`.
        ...
        handleAction: function ($e) {
            ...
            var activeFormData = $form.data('leapsActiveForm');
            if (activeFormData) {
                // remember who triggers the form submission. This is used by leaps.activeForm.js
            ...
            $form.trigger('submit');
            $.when($form.data('leapsSubmitFinalizePromise')).then(
                function () {
                    if (oldAction != null) {
    ...
    function initDataMethods() {
        ...
        $(document).on('click.leaps', pub.clickableSelector, handler)
            .on('change.leaps', pub.changeableSelector, handler);
    }
