...
return array(
    ...
    array(
        ...
        in <code>Leaps::t()</code>, non-latin languages with <code>Inflector::slug()</code>,
        <abbr title="Internationalized domain names">IDN</abbr>-feature of
        <code>EmailValidator</code> or <code>UrlValidator</code> or the <code>Leaps\I18n\Formatter</code> class.'
    ),
    array(
        'name' => 'ICU version',
        'mandatory' => false,
        ...
        Formatter::asRelativeTime()</a>) in the <code>Leaps\I18n\Formatter</code> class. Your current ICU version is ' .
        INTL_ICU_VERSION . '.'
    ),
    array(
    ...
    array(
        ...
        'memo' => 'Required for REST API to send XML responses via <code>Leaps\Web\XmlResponseFormatter</code>.'
    ),
);
