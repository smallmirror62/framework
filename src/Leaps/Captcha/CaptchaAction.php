 ...
 *
 * CaptchaAction is used together with [[Captcha]] and [[\Leaps\Captcha\CaptchaValidator]]
 ...
 *
 * 1. Override [[\Leaps\Web\Controller::actions()]] and register an action of class CaptchaAction with ID 'captcha'
...
class CaptchaAction extends Action
{
     ...
     */
    public $fontFile = '@Leaps/Captcha/SpicyRice.ttf';
    /**
    ...
    {
        $this->fontFile = Leaps::getAlias($this->fontFile);
    ...
    {
        Leaps::$app->getResponse()->getHeaders()
            ->set('Pragma', 'public')
            ->set('Expires', '0')
