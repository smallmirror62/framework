 ...
 *
 * To declare an ActiveRecord class you need to extend [[\Leaps\Db\ActiveRecord]] and
 * implement the `tableName` method:
 *
 * ```php
 * <?php
 *
 * class Customer extends \Leaps\Db\ActiveRecord
 * {
...
class ActiveRecord extends BaseActiveRecord
{
    ...
    {
        return Leaps::createObject(ActiveQuery::className(), [get_called_class()]);
    }
    ...
    public function insert($runValidation = true, $attributes = null)
    {
        if ($runValidation && !$this->validate($attributes)) {
            Leaps::info('Model not inserted due to validation error.', __METHOD__);
            return false;
        }
    ...
    public function update($runValidation = true, $attributeNames = null)
    {
        if ($runValidation && !$this->validate($attributeNames)) {
            Leaps::info('Model not updated due to validation error.', __METHOD__);
            return false;
        }
