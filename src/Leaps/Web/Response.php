 ...
 *
 * Response is configured as an application component in [[\Leaps\Web\Application]] by default.
 * You can access that instance via `Leaps::$app->response`.
 *
 ...
 * ~~~
 * 'response' => [
 *     'format' => Leaps\Web\Response::FORMAT_JSON,
 *     'charset' => 'UTF-8',
 *     // ...
 * ]
 * ~~~
 ...
 * @since 2.0
 */
class Response extends \Leaps\Base\Response
{
    /**
    ...
    public function init()
    {
        ...
        if ($this->charset === null) {
            $this->charset = Leaps::$app->charset;
        }
    ...
    protected function sendCookies()
    {
        ...
        foreach ($this->getCookies() as $cookie) {
            ...
            if ($cookie->expire != 1  && isset($validationKey)) {
                $value = Leaps::$app->getSecurity()->hashData(serialize([$cookie->name, $value]), $validationKey);
            }
     ...
     *
     * ~~~
     * return Leaps::$app->getResponse()->refresh();
     * ~~~
     *
    ...
    {
        return $this->redirect(Leaps::$app->getRequest()->getUrl() . $anchor);
    }
    ...
    {
        return [
            self::FORMAT_HTML => 'Leaps\Web\HtmlResponseFormatter',
    ...
    protected function prepare()
    {
        ...
        if (isset($this->formatters[$this->format])) {
            ...
            if (!is_object($formatter)) {
                $this->formatters[$this->format] = $formatter = Leaps::createObject($formatter);
            }
