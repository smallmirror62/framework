 ...
 *
 * View is configured as an application component in [[\Leaps\Base\Application]] by default.
 * You can access that instance via `Leaps::$app->view`.
 *
 ...
 * ~~~
 *
 * @property \Leaps\Web\AssetManager $assetManager The asset manager. Defaults to the "assetManager" application
 * component.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @since 2.0
 */
class View extends \Leaps\Base\View
{
    /**
     ...
     * @return \Leaps\Web\AssetManager the asset manager. Defaults to the "assetManager" application component.
     */
    public function getAssetManager()
    {
        return $this->_assetManager ?: Leaps::$app->getAssetManager();
    }

    /**
     * Sets the asset manager.
     * @param \Leaps\Web\AssetManager $value the asset manager
     */
