...
class StringValidator extends Validator
{
     ...
     * If this property is not set, [[\Leaps\Base\Application::charset]] will be used.
     */
    public $encoding;
    ...
    public function clientValidateAttribute($model, $attribute, $view)
    {
        ...
        if ($this->min !== null) {
            ...
            $options['tooShort'] = Leaps::$app->getI18n()->format($this->tooShort, [
                'attribute' => $label,
                'min' => $this->min,
            ], Leaps::$app->language);
        }
        if ($this->max !== null) {
            ...
            $options['tooLong'] = Leaps::$app->getI18n()->format($this->tooLong, [
                'attribute' => $label,
                'max' => $this->max,
            ], Leaps::$app->language);
        }
        if ($this->length !== null) {
            ...
            $options['notEqual'] = Leaps::$app->getI18n()->format($this->notEqual, [
                'attribute' => $label,
                'length' => $this->length,
            ], Leaps::$app->language);
        }
