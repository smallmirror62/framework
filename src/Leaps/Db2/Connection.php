...
use Leaps\Core\NotSupportedException;
...
class Connection extends Component
{
	...
	public function cache(callable $callable, $duration = null, $dependency = null)
	{
		$this->_queryCacheInfo [] = [ 
			$duration === null ? $this->queryCacheDuration : $duration,
			$dependency 
		];
		try {
	...
	protected function initConnection()
	{
		...
		if ($this->charset !== null && in_array ( $this->getDriverName (), [ 
			'pgsql',
			'mysql',
			'mysqli',
			'cubrid' 
	...
	public function beginTransaction($isolationLevel = null)
	{
		...
		if (($transaction = $this->getTransaction ()) === null) {
			$transaction = $this->_transaction = new Transaction ( [ 
				'db' => $this 
			] );
		}
	...
	/**
	 * 打开池中的服务器的连接。该方法实现了给定列表中的服务器之间的负载平衡。
	 *
