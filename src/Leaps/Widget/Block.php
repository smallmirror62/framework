...
/**
 * Block records all output between [[begin()]] and [[end()]] calls and stores it in [[\Leaps\Base\View::$blocks]].
 * for later use.
 *
 * [[\Leaps\Base\View]] component contains two methods [[\Leaps\Base\View::beginBlock()]] and [[\Leaps\Base\View::endBlock()]].
