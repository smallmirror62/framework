 ...
 *
 * An instance of Dispatcher is registered as a core application component and can be accessed using `Leaps::$app->log`.
 *
 ...
 *
 * ```php
 * Leaps::$app->log->targets['file']->enabled = false;
 * ```
 *
...
class Dispatcher extends Service
{
	 ...
	 *
	 * @property Logger the logger. If not set, [[\Leaps::getLogger()]] will be used.
