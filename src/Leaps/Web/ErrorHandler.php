...
class ErrorHandler extends \Leaps\Base\ErrorHandler
{
	 ...
	 *      using `Leaps::$app->errorHandler->exception. This property defaults to null, meaning ErrorHandler
	 ...
	 */
	public $errorView = '@Leaps/View/errorHandler/error.php';
	/**
	 *
	 * @var string the path of the view file for rendering exceptions.
	 */
	public $exceptionView = '@Leaps/View/errorHandler/exception.php';
	/**
	 *
	 * @var string the path of the view file for rendering exceptions and errors call stack element.
	 */
	public $callStackItemView = '@Leaps/View/errorHandler/callStackItem.php';
	/**
	 *
	...
	public function renderFile($_file_, $_params_)
	{
		...
		if ($this->exception instanceof ErrorException || ! Leaps::$app->has ( 'view' )) {
			ob_start ();
	...
	{
		if ($exception instanceof \Leaps\Base\Exception || $exception instanceof \Leaps\Base\InvalidCallException || $exception instanceof \Leaps\Base\InvalidParamException || $exception instanceof \Leaps\Base\UnknownMethodException) {
