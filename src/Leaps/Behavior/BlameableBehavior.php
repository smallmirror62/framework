 ...
 *
 * ```php
 * use Leaps\Behaviors\BlameableBehavior;
 *
...
class BlameableBehavior extends AttributeBehavior
{
	 ...
	 *      ```
	 *     
	 *      If this property is not set, the value of `Leaps::$app->user->id` will be assigned to the attribute(s).
	 */
	public $value;
