 ...
 *
 * UrlManager is configured as an application component in [[\Leaps\Base\Application]] by default.
 * You can access that instance via `Leaps::$app->urlManager`.
 *
...
class UrlManager extends Component
{
     ...
     */
    public $ruleConfig = ['class' => 'Leaps\Web\UrlRule'];
     ...
     *
     * Note that unlike [[\Leaps\Helper\Url::toRoute()]], this method always treats the given route
    ...
    public function getHostInfo()
    {
        if ($this->_hostInfo === null) {
            $request = Leaps::$app->getRequest();
            if ($request instanceof \Leaps\Web\Request) {
