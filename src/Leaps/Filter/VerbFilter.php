...
use Leaps;
use Leaps\Base\ActionEvent;
use Leaps\Base\Behavior;
use Leaps\Web\Controller;
use Leaps\Web\MethodNotAllowedHttpException;
 ...
 *     return [
 *         'verbs' => [
 *             'className' => \Leaps\Filter\VerbFilter::className(),
 *             'actions' => [
 *                 'index'  => ['get'],
 *                 'view'   => ['get'],
 *                 'create' => ['get', 'post'],
...
class VerbFilter extends Behavior
{
    ...
    public function beforeAction($event)
    {
        ...
        if (!in_array($verb, $allowed)) {
            ...
            Leaps::$app->getResponse()->getHeaders()->set('Allow', implode(', ', $allowed));
