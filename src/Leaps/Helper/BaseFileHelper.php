...
class BaseFileHelper
{
	 ...
	 */
	public static $mimeMagicFile = '@Leaps/Helper/mimeTypes.php';
	 ...
	 *        If not set, the value of [[\Leaps\Base\Application::language]] will be used.
	 * @param string $sourceLanguage the language that the original file is in.
	 *        If not set, the value of [[\Leaps\Base\Application::sourceLanguage]] will be used.
	...
	{
		if ($magicFile !== null) {
			$magicFile = Leaps::getAlias ( $magicFile );
		}
	 ...
	 * @throws \Leaps\Base\InvalidParamException if unable to open directory
	 */
	 ...
	 * @throws \Leaps\Base\Exception if the directory could not be created.
	 */
	public static function createDirectory($path, $mode = 0775, $recursive = true)
	{
		...
		try {
			...
			throw new \Leaps\Base\Exception ( "Failed to create directory '$path': " . $e->getMessage (), $e->getCode (), $e );
		}
	 ...
	 * should be ignored.
	 * The first match (i.e. the last on the list), if
