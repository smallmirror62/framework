...
abstract class DbTargetTest extends TestCase
{
	...
	public static function setUpBeforeClass()
	{
		...
		static::runConsoleAction ( 'migrate/up', [
	...
	{
		static::runConsoleAction ( 'migrate/down', [
			'migrationPath'=> '@yii/log/migrations/',
			'interactive'=> false
		] );
		if (static::$db) {
	...
	public function testTimestamp()
	{
		...
		$query = (new Query ())->select ( 'log_time' )->from ( self::$logTable )->where ( [
			'category'=> 'test'
		] );
