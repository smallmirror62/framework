 ...
 * ```
 *
 * You can also use this widget in an [[Leaps\Widgets\ActiveForm|ActiveForm]] using the [[Leaps\Widgets\ActiveField::widget()|widget()]]
 * method, for example like this:
 *
 * ```php
 * <?= $form->field($model, 'from_date')->widget(\Leaps\Widgets\MaskedInput::className(), [
 *     'mask' => '999-999-9999',
 * ]) ?>
 * ```
 *
