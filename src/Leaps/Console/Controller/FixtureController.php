 ...
 * leaps fixture/load User --namespace=alias\my\custom\namespace\goes\here
 * ~~~
 *
...
class FixtureController extends Controller
{
	 ...
	 * leaps fixture/load User UserProfile
	 *
	...
	public function actionLoad()
	{
		...
		if ($fixturesInput === [ ]) {
			...
			$helpCommand = Console::ansiFormat ( "leaps help fixture", [ 
				Console::FG_CYAN 
			] );
	 ...
	 * leaps fixture/unload User UserProfile
	 *
	 * # unload all fixtures found under 'tests\unit\fixtures'
	 * leaps fixture/unload "*"
	 *
	...
	private function notifyLoaded($fixtures)
	{
		...
		$this->stdout ( "\t\"" . Leaps::getAlias ( $this->namespace ) . "\"\n\n", Console::FG_GREEN );
	...
	private function findFixtures(array $fixtures = [])
	{
		...
		$files = FileHelper::findFiles ( $fixturesPath, [ 
			'only' => $filesToSearch 
		] );
		$foundFixtures = [ ];
	...
	{
		return Leaps::getAlias ( '@' . str_replace ( '\\', '/', $this->namespace ) );
	}
}
