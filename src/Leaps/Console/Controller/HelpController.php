...
class HelpController extends Controller
{
	...
	{
		$commands = $this->getModuleCommands ( Leaps::$app );
		sort ( $commands );
	 ...
	 *
	 * @param \Leaps\Core\Module $module the module instance
	...
	protected function validateControllerClass($controllerClass)
	{
		if (class_exists ( $controllerClass )) {
			...
			return ! $class->isAbstract () && $class->isSubclassOf ( 'Leaps\Console\Controller' );
		} else {
			return false;
		}
	}
	...
	{
		return basename ( Leaps::$app->request->scriptFile );
	}
}