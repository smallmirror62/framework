...
class AssetBundle extends Object
{
	...
	public function init()
	{
		if ($this->sourcePath !== null) {
			$this->sourcePath = rtrim ( Leaps::getAlias ( $this->sourcePath ), '/\\' );
		}
		if ($this->basePath !== null) {
			$this->basePath = rtrim ( Leaps::getAlias ( $this->basePath ), '/\\' );
		}
	 ...
	 * @param \Leaps\Web\View $view the view that the asset files are to be registered with.
	 */
